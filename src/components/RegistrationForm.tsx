...
export default function RegistrationForm() {
	...
	if (successData) {
		...
		return (
			<div className='relative py-24 overflow-hidden' id='register'>
				...
				<div className='relative max-w-md mx-auto px-4 sm:px-6'>
					<div className='bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/50 p-8 text-center'>
						...
						<p className='text-gray-500 mb-8'>
							Your secure session has been created successfully.
						</p>
						...
						<p className='text-sm text-gray-500 mb-6'>
							In a production environment, you would be automatically redirected to the
							verification flow.
						</p>
				...
				<div className='grid lg:grid-cols-2 gap-12 items-center'>
					<div>
						...
						<p className='text-lg text-gray-500 mb-8'>
							Join thousands of businesses trusting our platform for their identity
							verification needs. Simple integration, powerful results.
						</p>
