					...
					<main className='mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28'>
						<div className='sm:text-center lg:text-left'>
							...
							<h1 className='text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl mb-6'>
								<span className='block xl:inline'>{dict.title}</span>{" "}
							...
							<div className='mt-8 pt-8 border-t border-gray-100 flex flex-wrap items-center gap-6 text-sm text-gray-500 sm:justify-center lg:justify-start'>
								<div className='flex items-center gap-2'>
									...
									<span className='font-medium'>{dict.liveness}</span>
								</div>
								<div className='flex items-center gap-2'>
									<div className='p-1 bg-blue-100 rounded-full'>
										<FileText className='h-3 w-3 text-blue-600' />
									</div>
									<span className='font-medium'>{dict.ocr}</span>
								</div>
								<div className='flex items-center gap-2'>
									<div className='p-1 bg-green-100 rounded-full'>
										<ShieldCheck className='h-3 w-3 text-green-600' />
									</div>
									<span className='font-medium'>{dict.security}</span>
								</div>
							</div>
						</div>
					</main>
							...
							<div className='relative h-64 bg-gray-900 rounded-2xl flex items-center justify-center overflow-hidden group'>
								...
								<div className='absolute bottom-4 left-0 right-0 text-center'>
									<span className='inline-flex items-center px-3 py-1 rounded-full bg-black/50 backdrop-blur-sm border border-white/10 text-blue-200 text-xs font-mono'>
										...
										{dict.card.livenessDetected}: 99.8%
									</span>
								</div>
							</div>
							...
							<div className='space-y-3'>
								{/* <div className='flex items-center justify-between text-sm'>
									<span className='text-gray-500 flex items-center gap-2'>
										...
										{dict.card.deviceCheck}
									</span>
									<span className='text-green-600 font-medium flex items-center'>
										<CheckCircle className='w-3 h-3 mr-1' /> {dict.card.verified}
									</span>
								</div>
								...
								<div className='flex items-center justify-between text-sm'>
									<span className='text-gray-500'>{dict.card.documentScan}</span>
									<span className='text-green-600 font-medium flex items-center'>
										<CheckCircle className='w-3 h-3 mr-1' /> {dict.card.verified}
									</span>
								</div>
								...
								<div className='flex items-center justify-between text-sm pt-2'>
									<span className='text-gray-500'>{dict.card.faceMatch}</span>
									<span className='text-blue-600 font-medium flex items-center'>
										{dict.card.processing}
									</span>
								</div>
